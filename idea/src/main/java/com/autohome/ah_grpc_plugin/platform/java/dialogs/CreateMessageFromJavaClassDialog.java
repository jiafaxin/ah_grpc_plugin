...
public class CreateMessageFromJavaClassDialog extends DialogWrapper {
    Project project;
    LanguageTextField protoTextField;
    String message = "";

    public CreateMessageFromJavaClassDialog(Project project,String message) {
        super(project);
        this.message = message;
        this.project = project;
        setTitle("java class to message");
        init();
        setSize(1200,800);
    }
