...
public class ConsumerSupportGrpc extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        //go项目
        if(isGo){
            if (supportGRPC.supportGrpc(e.getProject(), e, currentPath,true)) {
                ...
                GenProtoService.getInstance(project).goConsumerCheck();
            }
            return;
        }
        if(supportGRPC.supportGrpc(e.getProject(), e, currentPath,true)) {
